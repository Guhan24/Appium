...
//		{
		public void configureAppium() throws MalformedURLException {
			...
			options.setDeviceName("Mura");
			//options.setUdid("mvcax8eugesghawg");
			options.setApp("D:\\UdamyNotes\\appium-master\\appium-master\\AppiumPixel\\src\\test\\java\\utils\\ApiDemos-debug.apk");
